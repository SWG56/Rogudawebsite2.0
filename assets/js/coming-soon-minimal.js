...
// Keep Studio/Marketplace links on Coming Soon page
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll('a[href$="studio.html"], a[href$="marketplace.html"]').forEach((a) => {
    a.setAttribute('href', 'comingsoon.html');
  });
});
